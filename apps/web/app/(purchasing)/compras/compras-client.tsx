...
export default function ComprasClient() {
  ...
  async function guardarCompra() {
    ...
    // Por cada ítem: crear lote y mover stock
    for (const it of items) {
      // 1) crear lote en stock_lots
      ...
      const mov = await supabase
        ...
        .insert({
          ...
          cantidad: it.cantidad,
          unit: it.unidad,
          motivo: 'compra'  // <- importante para reportes
        });
      ...
      // (opcional) podrías guardar costo y proveedor en una tabla purchases/purchase_items si ya la tienes
      // Aquí mantenemos simple: costo no afecta stock; lo puedes explotar en un futuro reporte de costos.
    }
